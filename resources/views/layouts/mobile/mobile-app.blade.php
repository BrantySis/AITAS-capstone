...
<aside class="sidebar flex flex-col p-6">
    ...
    <nav class="flex-1">
        ...
        <ul class="mt-2 space-y-1">
            <li>
                <a href="{{ route('dashboard.teacher') }}" class="sidebar-link @if(Request::routeIs('dashboard.teacher')) active @endif">
            ...
            <li>
                <a href="{{ route('teacher.attendance.index') }}" class="sidebar-link @if(Request::routeIs('teacher.load')) active @endif">
                    <span class="w-8 flex justify-center">
                        {{-- Attendance Icon SVG --}}
            ...
            <li>
                <a href="{{ route('teacher.schedule.index') }}" class="sidebar-link @if(Request::routeIs('teacher.load')) active @endif">
                    <span class="w-8 flex justify-center">
                        {{-- Attendance Icon SVG --}}
            ...
            <li>
                <a href="{{ route('teacher.load') }}" class="sidebar-link @if(Request::routeIs('teacher.classes.index')) active @endif">
                    <span class="w-8 flex justify-center">
            ...
            <li>
                <a href="#" class="sidebar-link @if(Request::routeIs('teacher.notifications')) active @endif">
                    <span class="w-8 flex justify-center">
