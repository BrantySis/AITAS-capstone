...
<aside class="sidebar flex flex-col p-6">
    ...
    <nav class="flex-1">
        ...
        <ul class="mt-2 space-y-1">
            <li>
                <a href="{{ route('dashboard.admin') }}" class="sidebar-link @if(Request::routeIs('dashboard.admin')) active @endif">
            ...
            <li>
                <a href="#" class="sidebar-link @if(Request::routeIs('admin.notifications.index')) active @endif">
                    <span class="w-8 flex justify-center">
